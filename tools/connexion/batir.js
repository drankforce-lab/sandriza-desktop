...
p("        message: 'La fenetre principale ne repond pas.' });");
p("    }");
...
p("      + f(IC.verrouSm, 'Connexion chiffrée de bout en bout (HTTPS)')");
p("      + f(IC.bouclier, 'Accès renforcé par mot de passe et authentification MFA')");
p("      + f(IC.epingle,  'Chaque tentative journalisée (adresse IP et pays)')");
p("      + '</ul>'");
...
p("      + (VERSION ? ('<div class=\"cx-ver\">Version ' + esc(VERSION) + '</div>') : '')");
p("      + '</div></aside>';");
p("  }");
p("");
...
p("      + '<div class=\"cx-titre\">Connexion sécurisée</div>'");
p("      + '<div class=\"cx-sous\">Réservé au personnel autorisé uniquement</div>'");
p("      + '</div>'");
p("      + '<form id=\"cx-form\">'");
p("      + '<div style=\"margin-bottom:1rem\">'");
p("      + '<label class=\"cx-lbl\" for=\"sl-email\">Nom d’utilisateur</label>'");
p("      + '<div class=\"cx-champ\"><span class=\"cx-ic\">' + IC.personne + '</span>'");
p("      + '<input type=\"text\" id=\"sl-email\" class=\"pad\" autocomplete=\"username\" required value=\"'");
p("      + esc(CTX.prefill) + '\"></div>'");
p("      + '</div>'");
p("      + '<div class=\"cx-souvenir\">'");
p("      + '<input type=\"checkbox\" id=\"sl-remember\"' + (CTX.souvenir ? ' checked' : '') + '>'");
p("      + '<label for=\"sl-remember\">Se souvenir de mon nom d’utilisateur</label>'");
p("      + '</div>'");
p("      + '<div style=\"margin-bottom:1.25rem\">'");
p("      + '<label class=\"cx-lbl\" for=\"sl-password\">Mot de passe</label>'");
p("      + '<div class=\"cx-champ\"><span class=\"cx-ic\">' + IC.cadenas + '</span>'");
p("      + '<input type=\"password\" id=\"sl-password\" class=\"pad padd\" autocomplete=\"current-password\" required>'");
p("      + '<button type=\"button\" class=\"cx-oeil\" id=\"sl-oeil\" aria-label=\"Afficher le mot de passe\">'");
p("      + IC.oeil + '</button></div>'");
p("      + '</div>'");
p("      + '<div class=\"cx-err\" id=\"sl-error\"></div>'");
p("      + '<div id=\"cap-zone\"></div>'");
p("      + '<button type=\"submit\" class=\"cx-btn\" id=\"sl-btn\" style=\"' + btnStyle() + '\">Se connecter</button>'");
p("      + '</form>'");
p("      + '<div class=\"cx-centre cx-recours' + (DEJA_RATE ? '' : ' cx-voile') + '\">'");
p("      + '<button type=\"button\" class=\"admlogin-forgot\" id=\"sl-oubli\">Mot de passe oublié ?</button>'");
p("      + '</div></div>';");
p("  }");
p("");
...
p("    return '<div>'");
p("      + '<div style=\"margin-bottom:1.75rem\">'");
p("      + '<div class=\"cx-titre\">Vérification en deux étapes</div>'");
p("      + '<div class=\"cx-sous\">Entrez le code de votre application d’authentification</div>'");
p("      + '<div class=\"cx-chrono\">⏱ Temps restant : <strong id=\"sl-mfa-timer\">' + sec + ' s</strong></div>'");
p("      + '</div>'");
p("      + '<form id=\"cx-form-mfa\">'");
p("      + '<div style=\"margin-bottom:1.25rem\">'");
p("      + '<label class=\"cx-lbl\" for=\"sl-mfa-code\">Code à 6 chiffres</label>'");
p("      + '<input type=\"text\" id=\"sl-mfa-code\" inputmode=\"numeric\" maxlength=\"6\"'");
p("      + ' autocomplete=\"one-time-code\" required placeholder=\"000000\">'");
p("      + '</div>'");
...
p("      : 'un super-administrateur';");
p("    return '<div>'");
p("      + '<div style=\"margin-bottom:1.2rem\">'");
p("      + '<div class=\"cx-titre\">Mot de passe oublié</div>'");
...
p("      + '<button type=\"button\" class=\"admlogin-back\" id=\"sl-oubli-retour\">← Retour à la connexion</button>'");
p("      + '</div></div>';");
p("  }");
p("");
...
p("      + '<label class=\"cx-lbl\">Vérification de sécurité</label>'");
p("      + '<div style=\"font-size:0.72rem;color:#7a6652;margin:-0.1rem 0 0.5rem\">'");
p("      + 'Faites glisser la pièce pour compléter l’image.</div>'");
...
p("      + '<div id=\"cap-hint\">Glissez vers la droite →</div>'");
...
p("        CAPTCHA_OK = true;");
p("        if (hint) hint.textContent = 'Vérifié';");
...
p("          poser(0);");
p("          if (hint) hint.textContent = 'Glissez vers la droite →';");
p("        }, 350);");
p("      }");
p("    };");
...
p("    var txt = esc((r && r.message) || 'L’opération a échoué.');");
...
p("    b.disabled = true;");
p("    b.innerHTML = '<span class=\"cx-spin\"></span><span>Connexion…</span>';");
p("    var sv = el('sl-remember');");
p("    appeler('connexion:entrer', [idc.value.trim(), pwc.value, !!(sv && sv.checked), CAPTCHA_OK])");
p("      .then(function(r){");
p("        var b2 = el('sl-btn');");
p("        if (!r.ok) {");
p("          if (b2) { b2.disabled = false; b2.textContent = 'Se connecter'; }");
p("          faute('sl-error', r);");
...
p("      dessiner('login');");
p("      faute('sl-error', { message: 'Délai de vérification dépassé — veuillez vous reconnecter.' });");
p("    });");
p("  }");
...
p("      return;");
p("    }");
p("    z.innerHTML = '<div class=\"admlogin-maint\"><strong>Maintenance en cours</strong>'");
...
p("      + '<strong>Désactivation d’urgence</strong>'");
...
p("      + '<label class=\"cx-lbl\" for=\"nip-champ\">NIP de désactivation</label>'");
...
p("      + '<div class=\"npr\"><button type=\"button\" id=\"nip-ok\">Lever la maintenance</button>'");
p("      + '<button type=\"button\" id=\"nip-non\">Annuler</button></div></div>';");
...
p("      oeil.setAttribute('aria-label', cache ? 'Masquer le mot de passe' : 'Afficher le mot de passe');");
p("      p2.focus();");
p("    };");
...
p("      try { navigator.clipboard.writeText(v); szDire('Clé copiée (sans les espaces).', 'bon'); }");
p("      catch (e) { szDire('La copie a échoué — recopiez la clé à la main.', 'att'); }");
p("    };");
p("    var wq = el('wz-qr');");
...
p("      if (CTX === REPLI) szDire('Décor par défaut — la fenêtre principale n’a pas répondu.', 'att');");
p("      socle();");
