...
.onglets button:hover{color:var(--tx)}
.onglets button[aria-selected="true"]{color:var(--tx-or);border-bottom-color:#c9a97e;font-weight:700}
...
.logo .aide{font-size:.75rem;color:var(--tx3);margin:0 0 .5rem}
...
.lgn .pastille{width:2.4rem;height:2.4rem;border-radius:10px;display:flex;align-items:center;
  justify-content:center;font:800 1.05rem/1 Georgia,serif;color:var(--tx-blanc)}
