...
.ch input,.ch textarea{width:100%;font:inherit;font-size:.83rem;color:#e8edf5;background:#0f1724;
...
.ch .etat{font-size:.72rem;color:#8fa1b8;margin-top:.25rem}
.ch .etat b{color:#4ade80}
.ch .etat.non b{color:#facc15}
.ch .aide{font-size:.7rem;color:#6d7f96;margin-top:.2rem}
