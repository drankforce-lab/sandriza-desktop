...
.stitre{font-size:.9rem;font-weight:700;color:#cbd8e6;margin:0 0 .2rem}
.sdesc{font-size:.76rem;color:#8fa1b8;margin:0 0 .8rem}
.bloc{display:flex;align-items:center;gap:.7rem;padding:.6rem .7rem;background:#0f1724;border:1px solid #2b3444;border-radius:9px;margin:0 0 .5rem}
.bloc .em{font-size:1.3rem;filter:grayscale(1) brightness(1.5)}
.bloc .nom{flex:1;min-width:0}
.bloc .nom b{font-size:.88rem}
.bloc .nom .d{font-size:.73rem;color:#8fa1b8}
.bloc .masq{font-size:.68rem;color:#facc15;margin-left:.35rem}
.bloc.off{opacity:.5}
...
.ch label{display:block;margin-bottom:.22rem;font-size:.74rem;color:#8fa1b8}
.ch input,.ch select,.ch textarea{width:100%;font:inherit;font-size:.83rem;color:#e8edf5;background:#0f1724;border:1px solid #2b3444;border-radius:8px;padding:.4rem .5rem}
...
.diapo{background:#0f1724;border:1px solid #2b3444;border-radius:10px;padding:.7rem .8rem;margin:0 0 .7rem}
...
.diapo .apercu .t{position:relative;color:#fff;font-size:.55rem;text-shadow:0 1px 2px rgba(0,0,0,.7);padding:0 .2rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%}
...
button.b{font:inherit;color:#e8edf5;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:.34rem .6rem;cursor:pointer;font-size:.78rem}
