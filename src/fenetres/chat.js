...
.ligne{background:#16202f;border:1px solid var(--v08);border-radius:11px;
...
.bulle.visiteur{align-self:flex-start;background:var(--v08)}
...
.bulle .qd{display:block;font-size:.64rem;color:var(--tx2);margin-top:.15rem}
