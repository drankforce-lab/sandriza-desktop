...
.sources label{display:flex;align-items:center;gap:.45rem;font-size:.82rem;cursor:pointer;
  border:1px solid rgba(255,255,255,.1);border-radius:9px;padding:.35rem .6rem;background:rgba(255,255,255,.03)}
...
.agent .vign{width:32px;height:32px;border-radius:50%;object-fit:cover;border:1px solid rgba(255,255,255,.18);flex:0 0 auto}
