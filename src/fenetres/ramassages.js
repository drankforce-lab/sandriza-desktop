...
button.prim{background:#8f6f42;border-color:#a3824f;color:var(--tx-creme2);font-weight:700}
...
input[type=number],input[type=text]{font:inherit;color:var(--tx);background:rgba(255,255,255,.05);
