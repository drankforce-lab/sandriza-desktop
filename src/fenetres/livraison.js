...
.ch input[type=number]{width:12rem;max-width:100%;font:inherit;color:var(--tx);background:#0f1724;
...
.pfiltre{font:inherit;color:var(--tx);background:#0f1724;border:1px solid #2b3444;
