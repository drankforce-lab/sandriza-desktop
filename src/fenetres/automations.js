...
.intro{flex:0 0 auto;padding:.75rem 1.05rem .2rem;font-size:.8rem;color:#8fa1b8;line-height:1.5}
...
.pill{font-size:.68rem;color:#8fa1b8;background:#111a29;border:1px solid rgba(255,255,255,.08);
  border-radius:99px;padding:.1rem .5rem}
.desc{font-size:.8rem;color:#8fa1b8;margin:0 0 .5rem}
.reco{font-size:.76rem;color:#cbd8e6;background:#111a29;border-left:3px solid #c9a97e;
...
.ch label{display:block;margin-bottom:.22rem;font-size:.73rem;color:#8fa1b8}
.ch input{width:100%;font:inherit;font-size:.82rem;color:#e8edf5;background:#0f1724;
...
.metriques .s{font-size:.72rem;color:#6d7f96;margin:0 0 .5rem}
...
button{font:inherit;font-size:.8rem;color:#e8edf5;background:rgba(255,255,255,.05);
...
<div class="tete"><span class="ic">⚙️</span><h1>Automatisations</h1></div>
