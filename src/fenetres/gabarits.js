...
.ch input[type=text],.ch select{width:100%;font:inherit;font-size:.83rem;color:#e8edf5;background:#0f1724;
...
.coul input[type=color]{height:36px;width:48px;padding:0;border:1px solid #2b3444;border-radius:8px;background:#0f1724;cursor:pointer;flex:0 0 auto}
.coul input[type=text]{flex:1;font-family:ui-monospace,Consolas,monospace}
.bascule{display:flex;align-items:flex-start;gap:.6rem;cursor:pointer;padding:.55rem .7rem;background:#0f1724;
  border:1px solid #2b3444;border-radius:9px;margin:0 0 .7rem;-webkit-user-select:none;user-select:none}
.bascule input{margin-top:.15rem;accent-color:#c9a97e;cursor:pointer;flex:0 0 auto}
.bascule .t{font-size:.82rem;font-weight:600}
.bascule .d{font-size:.72rem;color:#8fa1b8;line-height:1.45}
.apercu{border-radius:9px;overflow:hidden;font-size:12px;max-width:420px;margin:.2rem 0 .8rem;border:1px solid #2b3444}
.apercu .head{padding:16px 24px;text-align:center}
.apercu .head .ti{font-family:Georgia,serif;font-size:16px;font-weight:700;letter-spacing:4px;color:#fff}
...
.gifwrap .lg{font-size:.73rem;color:#8fa1b8;margin-bottom:.3rem;display:flex;align-items:center;gap:.5rem}
.gifwrap img{display:block;width:100%;border-radius:8px;border:1px solid #2b3444;background:#0f1724;min-height:60px}
@keyframes szshine{0%{background-position:0% 50%}100%{background-position:220% 50%}}
.anim{animation:szshine 6s linear infinite}
.ligne{display:flex;align-items:center;gap:1rem;padding:.6rem .8rem;background:#0f1724;border:1px solid #2b3444;border-radius:9px;margin:0 0 .55rem}
.ligne .nom{flex:1;font-size:.85rem;font-weight:600}
.ligne .def{font-size:.7rem;color:#8fa1b8;font-weight:400;margin-left:.4rem}
...
.swatch .lb{font-size:.68rem;color:#8fa1b8}
.tbl{width:100%;border-collapse:collapse;font-size:.8rem}
.tbl th{text-align:left;color:#8fa1b8;font-weight:600;padding:.45rem .6rem;border-bottom:1px solid rgba(255,255,255,.1);font-size:.72rem;text-transform:uppercase}
.tbl td{padding:.4rem .6rem;border-bottom:1px solid rgba(255,255,255,.05);vertical-align:middle}
.tbl td .mod{color:#8fa1b8}
.tbl select{width:100%;font:inherit;font-size:.8rem;color:#e8edf5;background:#0e1522;border:1px solid #2b3444;border-radius:7px;padding:.3rem .4rem}
...
button.b{font:inherit;color:#e8edf5;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);
