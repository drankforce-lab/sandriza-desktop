...
.lcard .nmedit{width:100%;font:inherit;font-size:.8rem;color:var(--tx);background:#0f1724;border:1px solid #2b3444;border-radius:6px;padding:.25rem .4rem}
...
.ch input{width:100%;font:inherit;font-size:.83rem;color:var(--tx);background:#0f1724;border:1px solid #2b3444;border-radius:8px;padding:.4rem .5rem}
.ch input:focus{outline:none;border-color:#c9a97e}
.modes,.rrow{display:flex;gap:.4rem;flex-wrap:wrap;margin:0 0 .6rem}
.modes button,.rrow button{font:inherit;font-size:.78rem;color:var(--tx);background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:.32rem .6rem;cursor:pointer}
...
button.b{font:inherit;color:var(--tx);background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:.32rem .7rem;cursor:pointer;font-size:.78rem}
...
.mini{font:inherit;font-size:.74rem;padding:.14rem .5rem;margin-left:.6rem;border:1px solid rgba(255,255,255,.16);border-radius:7px;background:rgba(255,255,255,.05);color:var(--tx);cursor:pointer;-webkit-user-select:none;user-select:none}
