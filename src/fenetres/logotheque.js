...
.lcard .th{height:110px;background:#0f1724 url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22><rect width=%228%22 height=%228%22 fill=%22%23172233%22/><rect x=%228%22 y=%228%22 width=%228%22 height=%228%22 fill=%22%23172233%22/></svg>');display:flex;align-items:center;justify-content:center}
...
.lcard .mt{font-size:.7rem;color:#8fa1b8;display:flex;flex-wrap:wrap;gap:.35rem}
...
.lcard .nmedit{width:100%;font:inherit;font-size:.8rem;color:#e8edf5;background:#0f1724;border:1px solid #2b3444;border-radius:6px;padding:.25rem .4rem}
.vide{padding:2rem 1rem;text-align:center;color:#8fa1b8;font-size:.85rem}
/* Import / recadrage */
...
.h{font-size:.74rem;font-weight:700;color:#cbd8e6;text-transform:uppercase;letter-spacing:.04em;margin:.2rem 0 .5rem}
.det .row{display:flex;justify-content:space-between;gap:.6rem;font-size:.8rem;padding:.15rem 0}
.det .row span{color:#8fa1b8}
.prevbox{background:#0f1724 url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22><rect width=%228%22 height=%228%22 fill=%22%23172233%22/><rect x=%228%22 y=%228%22 width=%228%22 height=%228%22 fill=%22%23172233%22/></svg>');border:1px solid #2b3444;border-radius:9px;min-height:150px;display:flex;align-items:center;justify-content:center;padding:.5rem}
...
.ch input{width:100%;font:inherit;font-size:.83rem;color:#e8edf5;background:#0f1724;border:1px solid #2b3444;border-radius:8px;padding:.4rem .5rem}
.ch input:focus{outline:none;border-color:#c9a97e}
.modes,.rrow{display:flex;gap:.4rem;flex-wrap:wrap;margin:0 0 .6rem}
.modes button,.rrow button{font:inherit;font-size:.78rem;color:#e8edf5;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:.32rem .6rem;cursor:pointer}
.modes button.on,.rrow button.on{background:#c9a97e;border-color:#c9a97e;color:#1a1208;font-weight:700}
.hint{font-size:.72rem;color:#6d7f96;line-height:1.5;margin:.2rem 0 .6rem}
...
button.b{font:inherit;color:#e8edf5;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:.32rem .7rem;cursor:pointer;font-size:.78rem}
button.b:hover:not(:disabled){background:rgba(255,255,255,.1)}
button.b:disabled{opacity:.5;cursor:default}
button.b.dgr{color:#fca5a5;border-color:rgba(248,113,113,.4)}
...
.mini{font:inherit;font-size:.74rem;padding:.14rem .5rem;margin-left:.6rem;border:1px solid rgba(255,255,255,.16);border-radius:7px;background:rgba(255,255,255,.05);color:#e8edf5;cursor:pointer;-webkit-user-select:none;user-select:none}
...
<div class="tete"><span class="ic">🖼️</span><h1>Logothèque</h1><span class="droite"></span></div>
...
${JS_ACTIVITE}${JS_DIRE}
  ...
  function listeHtml(){
    ...
    var h = '<div class="barre">'
      ...
      + '<span style="font-size:.78rem;color:#8fa1b8">Les dimensions vous seront présentées avant l’envoi. Stockage Cloudflare R2, réutilisable partout.</span></div>';
