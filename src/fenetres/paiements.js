...
.ref{font-family:'Courier New',monospace;font-size:.72rem;color:#8fa1b8}
.tot{font-weight:800;border-top:2px solid rgba(255,255,255,.16)!important;background:rgba(255,255,255,.03)}
.err{color:#f87171}.bon{color:#4ade80}.att{color:#fbbf24}
...
<div class="tete"><span class="ic">💳</span><h1>Paiements Square</h1>
