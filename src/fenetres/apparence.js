...
.th .nom{font-size:.72rem;color:#8fa1b8;white-space:nowrap}
.th[aria-pressed="true"] .nom{color:#e8edf5;font-weight:700}
...
<div class="tete"><span class="ic">🎨</span><h1>Thème et apparence</h1></div>
...
${JS_ACTIVITE}${JS_DIRE}
  ...
  function dessiner(){
    var d = D || {};
    var h = [];
    if (RO) { h.push('<div class="ro">Lecture seule : vous pouvez consulter les thèmes, pas les changer.</div>'); }
