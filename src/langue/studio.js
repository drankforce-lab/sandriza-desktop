...
module.exports = {
  ...
  // Recommencer, le brouillon et le cout du projet (2026-09-25).
  'Tout effacer : photo, réglages et rendu': 'Clear everything: photo, settings and render',
  '↺ Recommencer': '↺ Start over',
  'Recommencer ?': 'Start over?',
  'Recommencer': 'Start over',
  'La photo, les réglages et le rendu affiché seront effacés.': 'The photo, the settings and the render shown will be cleared.',
  'Le rendu payé n’est pas enregistré dans la photothèque.': 'The paid render is not saved in the photo library.',
  'Nouveau projet : tout est remis à zéro.': 'New project: everything is reset.',
  'Ce projet :': 'This project:',
  'crédits': 'credits',
  'crédit': 'credit',
  'restant': 'left',
  'aperçus gratuits': 'free previews',
  'aperçu gratuit': 'free preview',
  'Un projet du Studio': 'A Studio project',
  'Brouillon repris.': 'Draft restored.',
  // « Traiter ces 2 en lot… » : le « ces » n etait pas enveloppe.
  'ces': 'these',
