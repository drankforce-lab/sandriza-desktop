...
const actionApp = (nom) => {
  ...
  switch (nom) {
    ...
    case 'config-livraison': case 'config-retours': case 'config-navigation': case 'config-carriers': case 'config-automations': case 'config-telephonie': case 'config-models': {
